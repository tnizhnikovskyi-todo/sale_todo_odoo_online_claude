...
| оплата переказом на рахунок або при отриманні (онлайн-еквайринг — лише провайдером зі штатного переліку Odoo; українських у ньому немає) | `payment.provider` |  |
| один спосіб доставки з фіксованим тарифом (локальні перевізники без інтеграції; для України — ТТН вручну) | `delivery.carrier` |  |
...
| кілька способів оплати зі штатного переліку Odoo (локальних для країни Замовника може не бути; українських немає) | `payment.provider` |  |
